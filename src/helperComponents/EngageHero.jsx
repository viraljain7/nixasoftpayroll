      ...
      <div class="overflow-hidden bg-background">
        <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24 ">
          <h1 class="font-semibold text-foreground text-5xl md:text-6xl">
            <span class="text-primary">Fuel Acquisition.</span> Maximize
            Retention. Powered by Payments.
          </h1>
          <div class="mt-5 max-w-4xl">
            <p class="text-muted-foreground-1 text-lg">
              India’s first payments-led growth marketing engine that transforms
              every payment into a data-driven growth lever. Automate rewards,
              drive repeat purchases, and scale revenue without scaling
              complexity.{" "}
            </p>
          </div>
        </div>
      ...
      <div class="relative overflow-hidden pt-4 bg-background">
        ...
        <div class="relative z-10">
          <div class="max-w-5xl px-4 xl:px-0 mx-auto">
            <div class="mb-4">
              <h2 class="text-muted-foreground-1 text-xl mb-10">
