        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
          ...
          <div className="flex items-center lg:mb-0 mb-10">
            <div className="w-full">
              <h4 className="text-indigo-600 text-base font-medium mb-4 lg:text-left text-center">
                Contact Us
              </h4>

              <h2 className="text-gray-900 text-4xl font-semibold mb-9 lg:text-left text-center">
                Reach Out To Us
              </h2>
              ...
              <form>
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full h-14 rounded-full border border-gray-200 px-4 mb-6 focus:outline-none"
                />
                ...
                <textarea
                  ...
                  className="w-full h-40 rounded-2xl border border-gray-200 px-4 py-4 mb-6 resize-none focus:outline-none"
                />

                <button className="w-full h-12 rounded-full bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition">
                  Submit
                </button>
              </form>
            </div>
                ...
                <div class="">
                    <div class="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                        ...
                        <a href="javascript:;" class="flex items-center mb-6">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">94294 24199</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">info@nixasoft.com</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">
                              ...
                              SHREE SIDDHESHWAR PLAZA, Waghodia Road, Vadodara, Vadodara- 390025, Gujarat
                            </h5>
                        </a>
